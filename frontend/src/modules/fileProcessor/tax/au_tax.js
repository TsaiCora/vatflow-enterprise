// backend/src/modules/fileProcessor/parsers/au_tax.js

/**
 * 澳大利亚 GST 解析器
 * GST Return - Australian Taxation Office
 */
class AuTaxParser {
    constructor() {
        this.platform = 'au_tax';
        this.country = 'AU';
        this.type = 'gst_return';
        this.requiredFields = ['period', 'abn', 'total_gst'];
        this.gstRate = 10;
    }
