// backend/src/modules/fileProcessor/parsers/at_tax.js
/**
 * 奥地利 VAT 税务计算
 */
...
function validateVATNumber(vatNumber) {
    ...
    if (!pattern.test(vatNumber)) return { valid: false, message: '无效的奥地利 VAT 号码格式' };
...
function getVATSummary(transactions) {
    ...
    return { ...summary, currency: 'EUR', country: 'AT', countryName: '奥地利' };
}

module.exports = {
    VAT_RATES, calculateVAT, validateVATNumber, getVATSummary,
    countryCode: 'AT', countryName: '奥地利', currency: 'EUR', taxSystem: 'VAT'
};