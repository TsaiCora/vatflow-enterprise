// backend/src/modules/fileProcessor/certificates/au_import.js
/**
 * 澳大利亚进口VAT证明文件解析器
 * BAS - Australian Tax Office
 */

class AUImportParser {
    constructor() {
        this.country = 'AU';
        this.countryName = '澳大利亚';
        this.vatProof = 'BAS';
        this.customsDoc = 'Import Declaration';
        this.authority = 'Australian Tax Office';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new AUImportParser();
