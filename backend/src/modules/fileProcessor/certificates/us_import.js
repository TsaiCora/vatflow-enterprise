// backend/src/modules/fileProcessor/certificates/us_import.js
/**
 * 美国进口VAT证明文件解析器
 * Sales Tax Return - IRS / CBP
 */

class USImportParser {
    constructor() {
        this.country = 'US';
        this.countryName = '美国';
        this.vatProof = 'Sales Tax Return';
        this.customsDoc = 'Customs Entry';
        this.authority = 'IRS / CBP';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new USImportParser();
