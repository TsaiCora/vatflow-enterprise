// backend/src/modules/fileProcessor/certificates/ie_import.js
/**
 * 爱尔兰进口VAT证明文件解析器
 * VAT Return - Revenue Commissioners
 */

class IEImportParser {
    constructor() {
        this.country = 'IE';
        this.countryName = '爱尔兰';
        this.vatProof = 'VAT Return';
        this.customsDoc = 'Customs Declaration';
        this.authority = 'Revenue Commissioners';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new IEImportParser();
