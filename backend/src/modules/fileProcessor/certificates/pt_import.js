// backend/src/modules/fileProcessor/certificates/pt_import.js
/**
 * 葡萄牙进口VAT证明文件解析器
 * Declaração de IVA - Autoridade Tributária
 */

class PTImportParser {
    constructor() {
        this.country = 'PT';
        this.countryName = '葡萄牙';
        this.vatProof = 'Declaração de IVA';
        this.customsDoc = 'Declaração aduaneira';
        this.authority = 'Autoridade Tributária';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new PTImportParser();
