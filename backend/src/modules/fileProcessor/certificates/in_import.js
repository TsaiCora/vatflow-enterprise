// backend/src/modules/fileProcessor/certificates/in_import.js
/**
 * 印度进口VAT证明文件解析器
 * GSTR-1 - Central Board of Indirect Taxes
 */

class INImportParser {
    constructor() {
        this.country = 'IN';
        this.countryName = '印度';
        this.vatProof = 'GSTR-1';
        this.customsDoc = 'Bill of Entry';
        this.authority = 'Central Board of Indirect Taxes';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new INImportParser();
