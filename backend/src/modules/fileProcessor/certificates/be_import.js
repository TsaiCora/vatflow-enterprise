// backend/src/modules/fileProcessor/certificates/be_import.js
/**
 * 比利时进口VAT证明文件解析器
 * Certificat TVA - Service Public Fédéral Finances
 */

class BEImportParser {
    constructor() {
        this.country = 'BE';
        this.countryName = '比利时';
        this.vatProof = 'Certificat TVA';
        this.customsDoc = 'Document douanier';
        this.authority = 'Service Public Fédéral Finances';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new BEImportParser();
