// backend/src/modules/fileProcessor/certificates/ch_import.js
/**
 * 瑞士进口VAT证明文件解析器
 * MWST-Abrechnung - Eidgenössische Steuerverwaltung
 */

class CHImportParser {
    constructor() {
        this.country = 'CH';
        this.countryName = '瑞士';
        this.vatProof = 'MWST-Abrechnung';
        this.customsDoc = 'Zollanmeldung';
        this.authority = 'Eidgenössische Steuerverwaltung';
        this.period = '季度';
        this.format = 'PDF/XML';
    }
...
module.exports = new CHImportParser();
