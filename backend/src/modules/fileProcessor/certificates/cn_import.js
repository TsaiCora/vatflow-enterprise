// backend/src/modules/fileProcessor/certificates/cn_import.js
/**
 * 中国进口VAT证明文件解析器
 * 增值税申报表 - 国家税务总局
 */

class CNImportParser {
    constructor() {
        this.country = 'CN';
        this.countryName = '中国';
        this.vatProof = '增值税申报表';
        this.customsDoc = '进口报关单';
        this.authority = '国家税务总局';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new CNImportParser();
