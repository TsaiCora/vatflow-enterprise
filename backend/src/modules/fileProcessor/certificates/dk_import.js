// backend/src/modules/fileProcessor/certificates/dk_import.js
/**
 * 丹麦进口VAT证明文件解析器
 * Momsangivelse - Skattestyrelsen
 */

class DKImportParser {
    constructor() {
        this.country = 'DK';
        this.countryName = '丹麦';
        this.vatProof = 'Momsangivelse';
        this.customsDoc = 'Tolddeklaration';
        this.authority = 'Skattestyrelsen';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new DKImportParser();
