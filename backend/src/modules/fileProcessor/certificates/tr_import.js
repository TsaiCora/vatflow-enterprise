// backend/src/modules/fileProcessor/certificates/tr_import.js
/**
 * 土耳其进口VAT证明文件解析器
 * KDV Beyannamesi - Gelir İdaresi Başkanlığı
 */

class TRImportParser {
    constructor() {
        this.country = 'TR';
        this.countryName = '土耳其';
        this.vatProof = 'KDV Beyannamesi';
        this.customsDoc = 'Gümrük Beyannamesi';
        this.authority = 'Gelir İdaresi Başkanlığı';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new TRImportParser();
