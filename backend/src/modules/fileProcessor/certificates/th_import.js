// backend/src/modules/fileProcessor/certificates/th_import.js
/**
 * 泰国进口VAT证明文件解析器
 * ภาษีมูลค่าเพิ่ม - กรมสรรพากร
 */

class THImportParser {
    constructor() {
        this.country = 'TH';
        this.countryName = '泰国';
        this.vatProof = 'ภาษีมูลค่าเพิ่ม';
        this.customsDoc = 'ใบขนสินค้าขาเข้า';
        this.authority = 'กรมสรรพากร';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new THImportParser();
