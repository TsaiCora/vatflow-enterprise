// backend/src/modules/fileProcessor/certificates/jp_import.js
/**
 * 日本进口VAT证明文件解析器
 * 消費税申告書 - 国税庁
 */

class JPImportParser {
    constructor() {
        this.country = 'JP';
        this.countryName = '日本';
        this.vatProof = '消費税申告書';
        this.customsDoc = '輸入許可書';
        this.authority = '国税庁';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new JPImportParser();
