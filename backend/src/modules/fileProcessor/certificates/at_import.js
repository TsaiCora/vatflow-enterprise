// backend/src/modules/fileProcessor/certificates/at_import.js
/**
 * 奥地利进口VAT证明文件解析器
 * UVA-Meldung - Finanzamt
 */

class ATImportParser {
    constructor() {
        this.country = 'AT';
        this.countryName = '奥地利';
        this.vatProof = 'UVA-Meldung';
        this.customsDoc = 'Zollanmeldung';
        this.authority = 'Finanzamt';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new ATImportParser();
