// backend/src/modules/fileProcessor/certificates/mx_import.js
/**
 * 墨西哥进口VAT证明文件解析器
 * Declaración de IVA - SAT
 */

class MXImportParser {
    constructor() {
        this.country = 'MX';
        this.countryName = '墨西哥';
        this.vatProof = 'Declaración de IVA';
        this.customsDoc = 'Pedimento de importación';
        this.authority = 'SAT';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new MXImportParser();
