// backend/src/modules/fileProcessor/certificates/id_import.js
/**
 * 印度尼西亚进口VAT证明文件解析器
 * SPT PPN - Direktorat Jenderal Pajak
 */

class IDImportParser {
    constructor() {
        this.country = 'ID';
        this.countryName = '印度尼西亚';
        this.vatProof = 'SPT PPN';
        this.customsDoc = 'Pemberitahuan Impor';
        this.authority = 'Direktorat Jenderal Pajak';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new IDImportParser();
