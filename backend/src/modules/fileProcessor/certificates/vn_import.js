// backend/src/modules/fileProcessor/certificates/vn_import.js
/**
 * 越南进口VAT证明文件解析器
 * Tờ khai thuế GTGT - Tổng cục Thuế
 */

class VNImportParser {
    constructor() {
        this.country = 'VN';
        this.countryName = '越南';
        this.vatProof = 'Tờ khai thuế GTGT';
        this.customsDoc = 'Tờ khai hải quan';
        this.authority = 'Tổng cục Thuế';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new VNImportParser();
