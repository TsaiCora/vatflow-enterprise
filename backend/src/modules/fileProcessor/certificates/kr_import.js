// backend/src/modules/fileProcessor/certificates/kr_import.js
/**
 * 韩国进口VAT证明文件解析器
 * 부가가치세 신고서 - 국세청
 */

class KRImportParser {
    constructor() {
        this.country = 'KR';
        this.countryName = '韩国';
        this.vatProof = '부가가치세 신고서';
        this.customsDoc = '수입신고서';
        this.authority = '국세청';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new KRImportParser();
