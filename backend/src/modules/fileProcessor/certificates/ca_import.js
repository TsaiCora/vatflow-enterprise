// backend/src/modules/fileProcessor/certificates/ca_import.js
/**
 * 加拿大进口VAT证明文件解析器
 * GST/HST Return - CRA
 */

class CAImportParser {
    constructor() {
        this.country = 'CA';
        this.countryName = '加拿大';
        this.vatProof = 'GST/HST Return';
        this.customsDoc = 'Customs Invoice';
        this.authority = 'CRA';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new CAImportParser();
