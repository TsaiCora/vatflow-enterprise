// backend/src/modules/fileProcessor/certificates/ph_import.js
/**
 * 菲律宾进口VAT证明文件解析器
 * VAT Return - Bureau of Internal Revenue
 */

class PHImportParser {
    constructor() {
        this.country = 'PH';
        this.countryName = '菲律宾';
        this.vatProof = 'VAT Return';
        this.customsDoc = 'Import Declaration';
        this.authority = 'Bureau of Internal Revenue';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new PHImportParser();
