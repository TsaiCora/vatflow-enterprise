// backend/src/modules/fileProcessor/certificates/fi_import.js
/**
 * 芬兰进口VAT证明文件解析器
 * ALV-ilmoitus - Verohallinto
 */

class FIImportParser {
    constructor() {
        this.country = 'FI';
        this.countryName = '芬兰';
        this.vatProof = 'ALV-ilmoitus';
        this.customsDoc = 'Tulli-ilmoitus';
        this.authority = 'Verohallinto';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new FIImportParser();
