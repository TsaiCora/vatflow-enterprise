// backend/src/modules/fileProcessor/certificates/ru_import.js
/**
 * 俄罗斯进口VAT证明文件解析器
 * НДС-декларация - ФНС России
 */

class RUImportParser {
    constructor() {
        this.country = 'RU';
        this.countryName = '俄罗斯';
        this.vatProof = 'НДС-декларация';
        this.customsDoc = 'Таможенная декларация';
        this.authority = 'ФНС России';
        this.period = '季度';
        this.format = 'PDF/XML';
    }
...
module.exports = new RUImportParser();
