// backend/src/modules/fileProcessor/certificates/pl_import.js
/**
 * 波兰进口VAT证明文件解析器
 * Deklaracja VAT - Krajowa Administracja Skarbowa
 */

class PLImportParser {
    constructor() {
        this.country = 'PL';
        this.countryName = '波兰';
        this.vatProof = 'Deklaracja VAT';
        this.customsDoc = 'Dokument celny';
        this.authority = 'Krajowa Administracja Skarbowa';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new PLImportParser();
