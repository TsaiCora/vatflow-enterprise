// backend/src/modules/fileProcessor/certificates/my_import.js
/**
 * 马来西亚进口VAT证明文件解析器
 * SST Return - Royal Malaysian Customs
 */

class MYImportParser {
    constructor() {
        this.country = 'MY';
        this.countryName = '马来西亚';
        this.vatProof = 'SST Return';
        this.customsDoc = 'Import Declaration';
        this.authority = 'Royal Malaysian Customs';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new MYImportParser();
