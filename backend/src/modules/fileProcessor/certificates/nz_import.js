// backend/src/modules/fileProcessor/certificates/nz_import.js
/**
 * 新西兰进口VAT证明文件解析器
 * GST Return - Inland Revenue
 */

class NZImportParser {
    constructor() {
        this.country = 'NZ';
        this.countryName = '新西兰';
        this.vatProof = 'GST Return';
        this.customsDoc = 'Import Declaration';
        this.authority = 'Inland Revenue';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new NZImportParser();
