// backend/src/modules/fileProcessor/certificates/se_import.js
/**
 * 瑞典进口VAT证明文件解析器
 * Momsbesked - Skatteverket
 */

class SEImportParser {
    constructor() {
        this.country = 'SE';
        this.countryName = '瑞典';
        this.vatProof = 'Momsbesked';
        this.customsDoc = 'Tulldeklaration';
        this.authority = 'Skatteverket';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new SEImportParser();
