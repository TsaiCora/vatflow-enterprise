// backend/src/modules/fileProcessor/certificates/no_import.js
/**
 * 挪威进口VAT证明文件解析器
 * MVA-melding - Skatteetaten
 */

class NOImportParser {
    constructor() {
        this.country = 'NO';
        this.countryName = '挪威';
        this.vatProof = 'MVA-melding';
        this.customsDoc = 'Tolldeklarasjon';
        this.authority = 'Skatteetaten';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new NOImportParser();
