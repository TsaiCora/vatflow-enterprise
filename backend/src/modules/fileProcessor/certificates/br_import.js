// backend/src/modules/fileProcessor/certificates/br_import.js
/**
 * 巴西进口VAT证明文件解析器
 * Declaração de ICMS - Receita Federal
 */

class BRImportParser {
    constructor() {
        this.country = 'BR';
        this.countryName = '巴西';
        this.vatProof = 'Declaração de ICMS';
        this.customsDoc = 'DI - Declaração de Importação';
        this.authority = 'Receita Federal';
        this.period = '月度';
        this.format = 'PDF/XML';
    }
...
module.exports = new BRImportParser();
